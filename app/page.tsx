      ...
      <main className="relative z-10 flex min-h-[calc(100vh-140px)] flex-col items-center justify-center px-4 text-center pb-32">
        ...
        <div className="mt-8 flex flex-col items-center gap-12">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center justify-center">
            <AvatarHoverCard
              imageSrc="https://github.com/Macsig74.png"
              name="Macsig"
              username="macsig"
              description="Full stack developer , has work for big minecraft servers in the dev part, coded websites for them and other customers, also administrate databases and servers"
              variant="glass"
              align="right"
              buttonContent={
            ...
            />
            <AvatarHoverCard
              imageSrc="https://avatars.githubusercontent.com/u/151641467?s=400&u=a921a3f5833f4e527b22acdb302ae6d38969a8cf&v=4"
              name="Sharrk0"
              username="sharrk0"
              description="Experimentated builder with lots of experience in building for minecraft servers"
              variant="glass"
              align="left"
              buttonContent={
                <div className="flex gap-2 w-full">
